...
function App() {
  ...
  const messages = [
    "Hey Madam Jii✨ It's your VERY VERY Special Day!",
    "I've prepared something VERY SPECIAL just for you...🤞🏼🎁",
    "Before we begin, I want to say you are the BEST GIRL💖 I have ever met...",
    "To chaliye Shuru karee??",
  ];
